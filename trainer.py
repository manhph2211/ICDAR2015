_base_ = 'mmocr/configs/textdet/dbnet/dbnet_r18_fpnc_1200e_icdar2015.py'

load_from = 'mmocr/checkpoints/dbnet_r18_fpnc_sbn_1200e_icdar2015_20210329-ba3ab597.pth'
...
data = dict(
    ...
    test=dict(
        type=dataset_type,
        ann_file=data_root + '/instances_test.json',
        img_prefix=data_root + '/imgs/test',
        # select_first_k=100,
        pipeline=test_pipeline))
